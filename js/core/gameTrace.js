    ...
    var pros = {
        ...
        updateBalance: function() {
            ...
            ajaxData({
                ...
                successCallback: function(msg) {
                    ...
                    cfg.availableBalance.html(formatMoney(msg.abalance));
                    $(".top-money").text(formatMoney(msg.abalance));
                }
            });
        },
        ...
        initCheckboxAndInput: function() {
            ...
            $(document).on('keyup', '.trace-table-list table .input', function() {
                ...
                $(this).parents('tr').find('.trace-row-money').html(gagame.util.formatMoney(amount * onePrice, 3));
                that.fireEvent('updateTraceStatistics');
            });
        ...
        updateTraceStatistics: function(obj) {
            ...
            cfg.traceAmount.html(gagame.util.formatMoney(obj.amount, 3));
